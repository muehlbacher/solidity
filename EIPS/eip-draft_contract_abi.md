---
eip: <to be assigned>
title: Contract ABI encoding specification
author: Christian Reitwiessner (@chriseth), Gavin Wood, Alex Beregszaszi (@axic) et al.
discussions-to: <URL>
status: Draft
type: Interface
created: 2018-10-20
...
There are numerous contributors to the specification. This EIP only lists the major contributors on the top. Please review the change history of the above two links for clarity.

## Copyright

Not sure. It comes from the Wiki + Solidity's GPL3 documentation.
